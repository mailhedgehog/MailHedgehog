...
type AppConfig struct {
	...
	Storage struct {
		Use       string                                        `yaml:"use"`
		Config    contracts.MessagesStorageConfiguration        `yaml:"config"`
		Directory messagesStorageDirectory.StorageConfiguration `yaml:"directory"`
		MongoDB   struct {
	...
	Authentication struct {
		...
		File authenticationFile.StorageConfiguration `yaml:"file"`
