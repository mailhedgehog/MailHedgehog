<template>
  ...
  <div class="flex flex-1 flex-col lg:pl-64">
    <div class="flex h-16 flex-shrink-0 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 lg:border-none">
      <button type="button"
            ...
            <div>
              <MenuButton
                ...
                <img class="h-8 w-8 rounded-full"
                     ...
                     alt=""/>
                <ChevronDownIcon class="ml-1 h-5 w-5 flex-shrink-0 text-gray-400 dark:text-gray-600" aria-hidden="true"/>
              </MenuButton>
            </div>
            <transition enter-active-class="transition ease-out duration-100"
              ...
              <MenuItems
                ...
                <MenuItem v-slot="{ active }">
                  <a href="#" :class="[active ? 'bg-gray-100 dark:bg-gray-800' : '', 'block px-4 py-2 text-sm text-gray-700 dark:text-gray-400']">Your
                    Profile</a>
                </MenuItem>
                <MenuItem v-slot="{ active }">
                  <a href="#"
                ...
                <MenuItem v-slot="{ active }">
                  <a href="#" :class="[active ? 'bg-gray-100 dark:bg-gray-800' : '', 'block px-4 py-2 text-sm text-gray-700 dark:text-gray-400']">Logout</a>
                </MenuItem>
              </MenuItems>
            </transition>
          </Menu>
    ...
    <main class="flex-1 pb-8">
      <!-- Page header -->
      <div class="lg:mt-[2px] bg-white dark:bg-gray-900 shadow dark:shadow-gray-500">
